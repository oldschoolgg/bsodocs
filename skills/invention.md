...
| RoboFlappy (120)                | Provides extra loot from minigames, replicates the effect of discontinued pet [Flappy](../custom-items/pets.md#discontinued-pets) but with material costs | Magic\[4] Organic\[2] Metallic\[4]            |
