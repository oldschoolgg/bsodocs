...
| Klik       | <p>Automatically smelts ore from mining and cooks fish from fishing (no xp given)</p><p>3x tanning boost (Does not stack with dwgh)</p> | 1/7,500 Minutes of Killing Dragons                                                   |
...
| Takon      | 4x Smithing boost (not smelting)                                                                                                        | 1/4,500 from CoX                                                                     |
| Wilvus     | <p>Brings back pickpocket loot</p><p>2x thieving boost</p>                                                                              | 1/2,000 Minutes of Thieving                                                          |
...
| Queen Black Dragonling | No perk                                                                                                                               | Obtained from [QBD](../bosses/demi-bosses/queen-black-dragon.md#rewards)                      |
| Baby duckling          | No perk                                                                                                                               | Participate in the Megaduck community event.                                                  |
| Nexterminator          | No perk                                                                                                                               | Made with Bloodsoaked Feather from [Nex](../bosses/nex.md#loot) using `=create nexterminator` |
